...
BDB_INCLUDE_PATH=C:/deps/db-4.8.30.NC
BDB_LIB_PATH=C:/deps/db-4.8.30.NC
OPENSSL_INCLUDE_PATH=C:/deps/openssl-1.0.1h
...
QT += testlib
TARGET = Wealth currency-qt_test
...
macx:ICON = src/qt/res/icons/Wealth currency.icns
macx:TARGET = "Wealth currency-Qt"
